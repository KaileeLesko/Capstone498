...
def create(color1, color2, color3, color4, color5, color6):
    ...
    img4.save('img4.png')
    img5.save('img5.png')
    img1 = cv2.imread('../build/Images needed to Run/img.png')
    img2 = cv2.imread('../build/Images needed to Run/img1.png')
    img3 = cv2.imread('../build/Images needed to Run/img2.png')
    img4 = cv2.imread('../build/Images needed to Run/img3.png')
    img5 = cv2.imread('../build/Images needed to Run/img4.png')
    img6 = cv2.imread('../build/Images needed to Run/img5.png')
    im_h = cv2.hconcat([img1, img2, img3, img4, img5, img6])
    cv2.imwrite('../build/Images needed to Run/myImageColor.png', im_h)
...
def createwhite():
    ...
    img6 = cv2.imread('../build/Images needed to Run/img5.png')
    im_h = cv2.hconcat([img1, img2, img3, img4, img5, img6])
    cv2.imwrite('../build/Images needed to Run/whiteIMG.png', im_h)
